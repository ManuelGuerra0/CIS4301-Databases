...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER insert_not_cash_credit_checking
BEFORE INSERT ON Accounts
FOR EACH ROW
BEGIN
IF (NEW.type != 'cash' AND NEW.type != 'credit' AND NEW.type != 'checking')
THEN
SET NEW.type = 'cash';
END IF;
END */;;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER update_not_cash_credit_checking
...
CREATE TABLE `Customers` (
  ...
  KEY `FK_CustomersAccounts` (`aid`),
  CONSTRAINT `FK_CustomersAccounts` FOREIGN KEY (`aid`) REFERENCES `Accounts` (`aid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Employees` VALUES ('1010101','Zoey','Cashier',35000),('1101101','Alexander','Customer Service',40000),('1111111','Mario','Manager',80000),('1201201','Alyssa','Customer Service',40000),('1301301','Emma','Customer Service',40000),('1401401','Fiona','Inventory Taker',50000),('1501501','Jake','Inventory Manager',55000),('2222222','Luigi','Assistant Manager',75000),('3333333','Bill','Cashier',35000),('4444444','Ned','Cashier',35000),('5555555','Michael','Cashier',35000),('6666666','Patrick','Cashier',35000),('7777777','Kathy','Cashier',35000),('8888888','Lauren','Cashier',35000),('9999999','Julia','Cashier',35000);
...
CREATE TABLE `Employs` (
  ...
  KEY `FK_EmploysEmployees` (`eid`),
  CONSTRAINT `FK_EmploysEmployees` FOREIGN KEY (`eid`) REFERENCES `Employees` (`eid`),
  CONSTRAINT `FK_EmploysStores` FOREIGN KEY (`store`) REFERENCES `Stores` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Inventory` (
  ...
  KEY `FK_InventoryItems` (`item`),
  CONSTRAINT `FK_InventoryItems` FOREIGN KEY (`item`) REFERENCES `Items` (`item`),
  CONSTRAINT `FK_InventoryStores` FOREIGN KEY (`name`) REFERENCES `Stores` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER insert_item_does_not_exist
BEFORE INSERT ON Inventory
FOR EACH ROW
BEGIN
DECLARE cost DOUBLE;
SET cost = ROUND((SELECT AVG(price) FROM Items), 2);
IF NOT EXISTS (SELECT * FROM Items WHERE item = NEW.item)
THEN
INSERT INTO Items VALUES (NEW.item, 'generic', cost);
END IF;
IF NOT EXISTS (SELECT * FROM Stores WHERE name = NEW.name)
THEN
INSERT INTO Stores VALUES (NEW.name, 'ANYWHERE USA');
END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER update_item_does_not_exist
...
-- Dump completed on 2018-04-29 12:51:55
